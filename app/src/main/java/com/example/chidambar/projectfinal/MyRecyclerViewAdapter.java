...
/**
 * Created by Vinaykumar on 10-11-2015.
 */
...
public class MyRecyclerViewAdapter extends RecyclerView
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        holder.number.setText(mDataset.get(position).getmText1());
        holder.msg.setText(mDataset.get(position).getmText2());
        holder.dateTime.setText(mDataset.get(position).getmText3());
        holder.id.setText(mDataset.get(position).getmText4());
